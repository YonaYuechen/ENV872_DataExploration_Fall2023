...
#3. 
mean(seq1) > median(seq1) # whether mean is greater than the median, if yes return TRUE
```
...
Stu_TestScore <- data.frame(studentname,testscore,pass) # created a data frame
Stu_TestScore
```
