...
1. directly downloadable?
2. API provided?
3. check the website + /robots.txt
...
df_withdrawals <- data.frame("Month" = rep(1:12), # 1,2,3...,12
                             "Year" = rep(2000,12), # 12 2000
...
df_withdrawals <- df_withdrawals %>% 
  mutate(Registrant = !!the_registrant, # don't set this variable as a string, this is an variable
