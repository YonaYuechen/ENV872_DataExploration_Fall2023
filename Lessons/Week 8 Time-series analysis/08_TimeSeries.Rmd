...
wind_data_clean <- 
  wind_data %>% 
  mutate( AWND.clean = zoo::na.approx(AWND) ) ## :: can be used when different packages have the same name; or don't want to library the whole package; don't use na.omit / drop na when the na is in the middle of the datasat --> use na.approx (don't change row number) 
